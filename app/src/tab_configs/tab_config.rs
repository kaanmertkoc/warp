...
pub(crate) fn copy_env_files_to_worktree_command(worktree_path: &str) -> String {
    format!("find . -maxdepth 1 -type f -name '.env*' -exec cp -p {{}} {worktree_path}/ \\;")
}
    ...
    if worktree_branch_name.is_some() {
        ...
        pane.insert(
            ...
            Value::Array(vec![
                ...
                Value::String(copy_env_files_to_worktree_command(&worktree_path)),
