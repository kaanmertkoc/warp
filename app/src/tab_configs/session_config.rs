...
use super::tab_config::{
    copy_env_files_to_worktree_command, generated_worktree_path_string, TabConfig,
    TabConfigPaneNode, TabConfigPaneType, TabConfigParam, TabConfigParamType,
    AUTOGENERATED_BRANCH_NAME_PARAM,
};
...
pub fn build_tab_config(
    ...
    if enable_worktree {
        if autogenerate_worktree_branch_name {
            ...
            commands.push(copy_env_files_to_worktree_command(&worktree_path));
